...
export const SOCIAL_LINKS: SocialLink[] = [
  { link: "https://twitter.com/NashExchange", name: "Twitter", icon: xIcon },
  { link: "https://nashcore.substack.com/", name: "Substack", icon: substackIcon },
  { link: "https://github.com/nash-core", name: "Github", icon: githubIcon },
  { link: "https://t.me/+nBiLgG9RZQkwMzg1", name: "Telegram", icon: telegramIcon },
  { link: "https://discord.gg/nash_core", name: "Discord", icon: discordIcon },
];
